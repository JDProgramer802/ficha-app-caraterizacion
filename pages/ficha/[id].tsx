...
const MUNICIPIOS_MAP: Record<string, string[]> = {
  ...
  "Arauca": ["Arauca"],
  "Bolívar": ["Cartagena","Magangué","Arjona"],
  ...
  "Cundinamarca": ["Soacha","Zipaquirá","Girardot","Facatativá"],
  "Bogotá, D.C.": ["Bogotá"],
  "Guainía": ["Inírida"],
  ...
  "Putumayo": ["Mocoa"],
  "Quindío": ["Armenia","Montenegro","La Tebaida"],
  "Risaralda": ["Pereira","Dosquebradas"],
  "San Andrés y Providencia": ["San Andrés"],
  "Santander": ["Bucaramanga","Floridablanca","Barrancabermeja"],
  "Sucre": ["Sincelejo","Corozal","Sampués"],
  "Tolima": ["Ibagué","Espinal"],
  "Valle del Cauca": ["Cali","Palmira","Yumbo","Jamundí","Buenaventura"],
  "Vaupés": ["Mitú"],
